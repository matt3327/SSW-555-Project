...
public class GedcomParser {
    ...
    public class Family {
        ...
        private LocalDate marriedDatesdf;
        private boolean divorced;
        private String divorceDate;
        private LocalDate divorceDatesdf;
        private DateTimeFormatter formatter = new DateTimeFormatterBuilder().parseCaseInsensitive().appendPattern("d MMM yyyy").toFormatter();
        ...
        public void setMarriedDate(String marriedDate) {
            ...
            marriedDatesdf = LocalDate.parse(marriedDate, formatter);
            this.divorced = false;
        }
        ...
        public LocalDate getMarriedDatesdf() {
            return this.marriedDatesdf;
        }

        public void setDivorceDate(String divorceDate) {
            this.divorceDate = divorceDate;
            divorceDatesdf = LocalDate.parse(divorceDate, formatter);
            this.divorced = true;
        }
        ...
        public LocalDate getDivorceDatesdf() {
            return this.divorceDatesdf;
        }
        ...
        public boolean validMarriageDivorceDate(){
            if(marriedDatesdf.compareTo(divorceDatesdf) < 0){
                return false;
            }
            else{
                return true;
    ...
    public static void main(String[] args) throws FileNotFoundException, Exception {
        ...
        Boolean validMarriageDivorce = true;
                        ...
                        while (!parts[0].equals("0")) {
                            ...
                            // adding married and divorced information
                    			...
                    			if (parts[1].equals("MARR")) {
                                    ...
                                    LocalDate marryDate = getFamilyById(currentId).getMarriedDatesdf();
                                    LocalDate divorceDate = getFamilyById(currentId).getDivorceDatesdf();
                                    validMarriageDivorce = getFamilyById(currentId).validMarriageDivorceDate();
