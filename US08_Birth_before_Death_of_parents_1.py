...
class Test(unittest.TestCase):
    def test_birthDate_before_parent_death(self):
        ...
        husband.deathDateObject = datetime(2000,9,13)
        wife = Individual("I2")
        ...
        US08_check_child_birth_before_parents_death_error(fam,husband,wife,child1)
        self.assertEqual(len(fam.errors), 1) 
        self.assertEqual(fam.errors, [])

    def test_birthDate_before_parent_death1(self):
        husband = Individual("I1")
        husband.deathDateObject = datetime(2003,9,13)
        wife = Individual("I2")
    ...
    def test_birthDate_before_parent_death2(self):
        husband = Individual("I1")
        husband.deathDateObject = datetime(2017,9,13)
        wife = Individual("I2")
